...
class LoadingBanner extends StatefulWidget {
  const LoadingBanner({Key? key, this.size = 40}) : super(key: key);
  final double size;
  @override
...
class _LoadingBannerState extends State<LoadingBanner>
  ...
  final Color color1 = const Color(0xFF13344C);
  final Color color2 = const Color(0xFF3397B9);
  final Color color3 = const Color(0xFFECF1FA);
